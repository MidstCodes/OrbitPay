...
export default function SettingsPage() {
  ...
  const settings = [
    ...
    { label: 'Network Passphrase', value: config.networkPassphrase, description: 'Used for transaction signing' },
    ...
    { label: 'Event Polling', value: config.enableEvents ? 'Enabled' : 'Disabled', description: 'Real-time event synchronization' },
    { label: 'Poll Interval', value: `${config.pollIntervalMs}ms`, description: 'Event polling frequency' },
  ];
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="px-4 lg:px-6 py-6 space-y-6 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="divide-y divide-gray-50">
                {settings.map((setting) => (
                  <div key={setting.label} className="px-6 py-4 flex items-start justify-between">
                    <div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-2">About OrbitPay</h2>
